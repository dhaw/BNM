function f=bnm2sub%(A)%a=alpha, b=beta
%
basins=0;
a=9; g=1; b1=40; b2=40;
...
%
%Fixed points:
plot(fpx,fpz,'ko','markersize',ms,'markerfacecolor','k','linewidth',1)
plot(fpx([2,4]),fpz([2,4]),'ko','markersize',ms,'markerfacecolor','w','linewidth',1)
plot(fpx(3),fpz(3),'ko','markersize',ms,'markerfacecolor',[.75,.75,.75],'linewidth',1)
%Top right box:
